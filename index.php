    ...
    <div class="content">
        <div class="column column-3 border"><a href="#"><img src="<?php bloginfo('template_url')?>/img/phone.png" alt=""></a></div>
        <div class="column column-3 border"><a href="#"><img src="<?php bloginfo('template_url')?>/img/basket.png" alt=""></a></div>
        <div class="column column-3 border"><a href="#"><img src="<?php bloginfo('template_url')?>/img/earth.png" alt=""></a></div>
        <div class="column column-3 border"><a href="#"><img src="<?php bloginfo('template_url')?>/img/search.png" alt=""></a></div>
        <div class="clearfix"></div>
